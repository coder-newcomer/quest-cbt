...
See the [open issues](https://github.com/coder-newcomer/quest-cbt/issues) for a list of proposed features and known issues.

- [Top Feature Requests](https://github.com/coder-newcomer/quest-cbt/issues?q=label%3Aenhancement+is%3Aopen+sort%3Areactions-%2B1-desc) (Add your votes with <kbd>👍</kbd>)
- [Top Bugs](https://github.com/coder-newcomer/quest-cbt/issues?q=is%3Aissue+is%3Aopen+label%3Abug+sort%3Areactions-%2B1-desc) (Add your votes with <kbd>👍</kbd>)
- [Newest Bugs](https://github.com/coder-newcomer/quest-cbt/issues?q=is%3Aopen+is%3Aissue+label%3Abug)
- [TODO](TODO.md) list

## 💬 Support

This project is still on early stage of development. Contributions and PRs are very welcome. See for further information about [contributing](docs/CONTRIBUTING.md).

If you have any questions, please feel free to [open an issue](https://github.com/coder-newcomer/quest-cbt/issues/new/choose). Or reach out maintainers at [GitHub issues](https://github.com/coder-newcomer/quest-cbt/issues/new?assignees=&labels=question&template=04_SUPPORT_QUESTION.md&title=support%3A+) or [contact the contibutors](https://github.com/coder-newcomer/quest-cbt/contributors) further.
